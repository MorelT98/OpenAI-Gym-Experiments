...
class FeatureTransformer:
    def __init__(self):
        ...
        self.cat_position_bins = np.linspace(-2.4, 2.4, 9)
    ...
    def transform(self, observation):
        ...
        return build_state([
            to_bin(cart_pos, self.cat_position_bins),
...
#
# env = wrappers.Monitor(env, 'cartPole_videos', force=True)
# play_one(model, 0, gamma)
